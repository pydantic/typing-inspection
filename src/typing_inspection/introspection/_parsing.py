...
from typing import Any, ForwardRef, Protocol, Literal

from typing_inspection import typing_objects

from typing_extensions import Unpack, TypeVar, get_origin

OriginT = TypeVar('OriginT', default=Any)

class GenericAlias(Protocol[OriginT]):
...
class TypeHintVisitor:
    ...
    def visit_generic_alias(self, hint: GenericAlias, origin: Any) -> None:
        if not typing_objects.is_literal(origin):
            ...
            # `hint.__args__` should be guaranteed to be a "flattened" version of the arguments.
...
class TypeHintTransformer:
    ...
    def visit_generic_alias(self, hint: GenericAlias, origin: Any) -> Any:
